...
((root,factory)=>{const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;if(root)root.B1070TaxEstimate=api;})(typeof window!=='undefined'?window:null,()=>{
  ...
  function calculate(items,year){
    ...
    const result={year:selected,sales:0,securitySales:0,taxableNet:0,nisaNet:0,cryptoNet:0,taxableSales:0,nisaSales:0,cryptoSales:0,unknownAccount:0,unknownCost:0,cryptoUnknownCost:0,estimatedTax:null,canEstimate:false};
    ...
    result.canEstimate=result.securitySales>0&&result.unknownAccount===0&&result.unknownCost===0;
